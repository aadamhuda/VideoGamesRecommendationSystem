...
<template>
    <div class="jumbotron">
        <h1 class="display-4  text-light py-1 px-3">Dislike List</h1>
            ...
            <div class="col-8" v-if="!this.empty">
                <div class="container lead text-light overflow-auto" style="max-height: 70vh;">
                    ...
                    <div class="btn-group"> 
                        ...
                        <button class="mx-1 btn btn-outline-warning" @click="complete(curr_game)" type="submit">Complete</button>
